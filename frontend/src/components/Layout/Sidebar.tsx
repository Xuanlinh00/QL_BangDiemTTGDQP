...
export default function Sidebar() {
  ...
  return (
    <aside className="w-72 bg-white dark:bg-slate-900 text-gray-700 dark:text-gray-200 transition-all duration-300 flex flex-col shadow-lg flex-shrink-0 border-r border-gray-200 dark:border-slate-700">
      ...
      <div className="bg-[#2563EB] p-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="text-white font-semibold text-sm leading-snug">TRUNG TÂM GIÁO DỤC <br /> QUỐC PHÒNG VÀ AN NINH</span>
          </div>
        </div>
      </div>
