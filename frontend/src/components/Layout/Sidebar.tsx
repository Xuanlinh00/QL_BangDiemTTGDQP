...
const menuSections = [
  {
    ...
    items: [
      ...
      { label: 'Phát chứng nhận', path: '/certificate-issuance', icon: 'certificate' },
    ]
  },
  {
    title: 'DỮ LIỆU',
    items: [
      { label: 'Sinh viên & Điểm', path: '/data', icon: 'data' },
    ]
  },
  {
    title: 'HỆ THỐNG',
...
function NavIcon({ name, className }: { name: string; className?: string }) {
  ...
  const icons: Record<string, JSX.Element> = {
    dashboard: <svg className={cls} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>,
    ...
    certificate: <svg className={cls} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4M7 12a5 5 0 1110 0 5 5 0 01-10 0z" /></svg>,
